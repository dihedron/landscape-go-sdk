...
_APPLICATION_DESCRIPTION := Manage data on Canonical Landscape via CLI.
...
_APPLICATION_METADATA_PACKAGE=$$(grep "module .*" go.mod | sed 's/module //gi')/pkg/metadata
_APPLICATION_DOTENV_VAR_NAME=LANDSCAPE_DOTENV
